    ...
    <div class="flex flex-col gap-10">
      ...
      <div class="relative">
        ...
        <!-- EMAIL INPUT BOX -->
      	...
      	<p id="emailError" class="hidden text-right text-red-400 font-medium mr-4 p-1 bi bi-exclamation-triangle-fill">&nbsp;Email not recognized!</p>
    	</div>
        ...
        <p id="pwdError" class="hidden text-right text-red-400 font-medium mr-4 p-1 bi bi-exclamation-triangle-fill">&nbsp;Invalid password!</p>
	    </div>
