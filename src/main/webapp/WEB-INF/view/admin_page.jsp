...
<header class="fixed w-full bg-[#0e263d] z-50 drop-shdaow-lg flex justify-between px-4 text-sky-500">
	...
	<a class="p-1 px-4 font-medium border-2 border-transparent rounded-full hover:border-sky-500 active:bg-sky-500 active:text-white/75" href="contact">Contact Us</a>
	...
	<main class="pt-24">
		<div class="flex justify-between items-center mb-4 px-3">
			<h2 class="text-2xl font-medium p-3">Create new content</h2>
			<a href="history" class="text-xl p-3 px-6 bg-sky-500 border-2 border-sky-500 rounded-lg text-white/75 hover:bg-transparent">Order History</a>
		</div>
